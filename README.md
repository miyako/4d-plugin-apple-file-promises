...
Maybe it is because [``namesOfPromisedFilesDroppedAtDestination:``](https://developer.apple.com/documentation/appkit/nsdragginginfo/1415980-namesofpromisedfilesdroppedatdes) has been deprecated in 10.13. It seems like [``performDragOperation:``](https://developer.apple.com/documentation/appkit/nsdraggingdestination/1415970-performdragoperation?language=objc) is no longer invoked, even if the destination has returned ``YES`` in [``prepareForDragOperation:``](https://developer.apple.com/documentation/appkit/nsdraggingdestination/1416066-preparefordragoperation?language=objc).
